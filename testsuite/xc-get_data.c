...
int main(int argc, char *argv[])
{
  ...
  if(xc_func_init_cuda(&func, xc.functional, xc.nspin) != 0){
  ...
  switch(func.info->family)
    {
    case XC_FAMILY_LDA:
      xc_lda_cuda(&func, 1, xc.rho, pzk, pvrho, pv2rho2, pv3rho3);
      break;

    case XC_FAMILY_GGA:
    case XC_FAMILY_HYB_GGA:
      xc_gga_cuda(&func, 1, xc.rho, xc.sigma,
	     pzk, pvrho, pvsigma, pv2rho2, pv2rhosigma, pv2sigma2, NULL, NULL, NULL, NULL);
      break;

    case XC_FAMILY_MGGA:
    case XC_FAMILY_HYB_MGGA:
      xc_mgga_cuda(&func, 1, xc.rho, xc.sigma, xc.lapl, xc.tau,
