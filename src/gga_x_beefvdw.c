...
const xc_func_info_type_cuda xc_func_info_gga_x_beefvdw = {
  XC_GGA_X_BEEFVDW,
  XC_EXCHANGE,
  "BEEF-vdW exchange",
  XC_FAMILY_GGA,
...
void
gga_xc_beefvdw_init(xc_func_type_cuda *p)
{
  static int   funcs_id  [3] = {XC_GGA_X_BEEFVDW, XC_LDA_C_PW_MOD, XC_GGA_C_PBE_cuda};
  static double funcs_coef[3] = {1.0, 0.6001664769, 1.0 - 0.6001664769};

  xc_mix_init(p, 3, funcs_id, funcs_coef);
}

const xc_func_info_type_cuda xc_func_info_gga_xc_beefvdw = {
  XC_GGA_XC_BEEFVDW,
