...
static void
gga_xc_xlyp_init(xc_func_type_cuda *p)
{
...
const xc_func_info_type_cuda xc_func_info_gga_xc_xlyp = {
  XC_GGA_XC_XLYP,
...
static void
gga_xc_pbe1w_init(xc_func_type_cuda *p)
{
  static int   funcs_id  [3] = {XC_LDA_C_VWN, XC_GGA_X_PBE_cuda, XC_GGA_C_PBE_cuda};
  static double funcs_coef[3] = {1.0 - 74.0/100.0, 1.0, 74.0/100.0};

  xc_mix_init(p, 3, funcs_id, funcs_coef);
}

const xc_func_info_type_cuda xc_func_info_gga_xc_pbe1w = {
  XC_GGA_XC_PBE1W,
  XC_EXCHANGE_CORRELATION,
  "PBE1W",
  XC_FAMILY_GGA,
...
static void
gga_xc_mpwlyp1w_init(xc_func_type_cuda *p)
{
...
const xc_func_info_type_cuda xc_func_info_gga_xc_mpwlyp1w = {
  XC_GGA_XC_MPWLYP1W,
  XC_EXCHANGE_CORRELATION,
  "mPWLYP1w",
  XC_FAMILY_GGA,
...
static void
gga_xc_pbelyp1w_init(xc_func_type_cuda *p)
{
  static int   funcs_id  [3] = {XC_LDA_C_VWN, XC_GGA_X_PBE_cuda, XC_GGA_C_LYP};
  static double funcs_coef[3] = {1.0 - 74.0/100.0, 1.0, 74.0/100.0};

  xc_mix_init(p, 3, funcs_id, funcs_coef);
}

const xc_func_info_type_cuda xc_func_info_gga_xc_pbelyp1w = {
  XC_GGA_XC_PBELYP1W,
  XC_EXCHANGE_CORRELATION,
  "PBELYP1W",
  XC_FAMILY_GGA,
