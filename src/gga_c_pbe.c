...
#define XC_GGA_C_PBE_cuda          130 /* Perdew, Burke & Ernzerhof correlation              */
...
const xc_func_info_type_cuda xc_func_info_gga_c_pbe = {
  XC_GGA_C_PBE_cuda,
  XC_CORRELATION,
...
const xc_func_info_type_cuda xc_func_info_gga_c_pbe_sol = {
  XC_GGA_C_PBE_SOL,
  XC_CORRELATION,
...
const xc_func_info_type_cuda xc_func_info_gga_c_xpbe = {
  XC_GGA_C_XPBE,
  XC_CORRELATION,
...
const xc_func_info_type_cuda xc_func_info_gga_c_pbe_jrgx = {
  XC_GGA_C_PBE_JRGX,
  XC_CORRELATION,
...
const xc_func_info_type_cuda xc_func_info_gga_c_rge2 = {
  XC_GGA_C_RGE2,
  XC_CORRELATION,
  "Regularized PBE",
  XC_FAMILY_GGA,
...
const xc_func_info_type_cuda xc_func_info_gga_c_apbe = {
  XC_GGA_C_APBE,
  XC_CORRELATION,
...
const xc_func_info_type_cuda xc_func_info_gga_c_spbe = {
  XC_GGA_C_SPBE,
  XC_CORRELATION,
...
const xc_func_info_type_cuda xc_func_info_gga_c_pbeint = {
  XC_GGA_C_PBEINT,
  XC_CORRELATION,
...
const xc_func_info_type_cuda xc_func_info_gga_c_pbefe = {
  XC_GGA_C_PBEFE,
  XC_CORRELATION,
...
const xc_func_info_type_cuda xc_func_info_gga_c_pbe_mol = {
  XC_GGA_C_PBE_MOL,
  XC_CORRELATION,
...
const xc_func_info_type_cuda xc_func_info_gga_c_tm_pbe = {
  XC_GGA_C_TM_PBE,
  XC_CORRELATION,
