...
static void
hyb_gga_xc_pbeh_init(xc_func_type_cuda *p)
{
  static int   funcs_id  [2] = {XC_GGA_X_PBE_cuda, XC_GGA_C_PBE_cuda};
...
const xc_func_info_type_cuda xc_func_info_hyb_gga_xc_pbeh = {
  XC_HYB_GGA_XC_PBEH,
...
static void
hyb_gga_xc_pbe0_13_init(xc_func_type_cuda *p)
{
  static int   funcs_id  [2] = {XC_GGA_X_PBE_cuda, XC_GGA_C_PBE_cuda};
...
const xc_func_info_type_cuda xc_func_info_hyb_gga_xc_pbe0_13 = {
...
static void
hyb_gga_xc_hpbeint_init(xc_func_type_cuda *p)
{
...
const xc_func_info_type_cuda xc_func_info_hyb_gga_xc_hpbeint = {
...
static void
hyb_gga_xc_pbemol0_init(xc_func_type_cuda *p)
{
...
const xc_func_info_type_cuda xc_func_info_hyb_gga_xc_pbe_mol0 = {
...
static void
hyb_gga_xc_pbesol0_init(xc_func_type_cuda *p)
{
...
const xc_func_info_type_cuda xc_func_info_hyb_gga_xc_pbe_sol0 = {
...
static void
hyb_gga_xc_pbeb0_init(xc_func_type_cuda *p)
{
  static int   funcs_id  [2] = {XC_GGA_X_PBE_cuda, XC_GGA_C_PBE_cuda};
  static double funcs_coef[2] = {1.0 - 0.25, 1.0};
...
const xc_func_info_type_cuda xc_func_info_hyb_gga_xc_pbeb0 = {
  XC_HYB_GGA_XC_PBEB0,
  XC_EXCHANGE_CORRELATION,
  "PBEbeta0",
  XC_FAMILY_HYB_GGA,
...
static void
hyb_gga_xc_pbemolb0_init(xc_func_type_cuda *p)
{
  static int   funcs_id  [2] = {XC_GGA_X_PBE_MOL, XC_GGA_C_PBE_MOL};
  static double funcs_coef[2] = {1.0 - 0.25, 1.0};
...
const xc_func_info_type_cuda xc_func_info_hyb_gga_xc_pbe_molb0 = {
...
static void
hyb_gga_xc_pbe50_init(xc_func_type_cuda *p)
{
  static int   funcs_id  [2] = {XC_GGA_X_PBE_cuda, XC_GGA_C_PBE_cuda};
...
const xc_func_info_type_cuda xc_func_info_hyb_gga_xc_pbe50 = {
  XC_HYB_GGA_XC_PBE50,
  XC_EXCHANGE_CORRELATION,
  "PBE50",
  XC_FAMILY_HYB_GGA,
