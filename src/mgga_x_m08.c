...
static void
mgga_x_m08_init(xc_func_type_cuda *p)
{
...
const xc_func_info_type_cuda xc_func_info_hyb_mgga_x_m08_hx = {
...
const xc_func_info_type_cuda xc_func_info_hyb_mgga_x_m08_so = {
