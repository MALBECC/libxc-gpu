...
void
xc_hyb_gga_xc_lcy_pbe_init(xc_func_type_cuda *p)
{
  static int   funcs_id  [2] = {XC_GGA_X_SFAT, XC_GGA_C_PBE_cuda};
  ...
  xc_gga_x_sfat_set_params(p->func_aux[0], XC_GGA_X_PBE_cuda, gamma);
  p->cam_omega = gamma;
  p->cam_alpha = 1.0;
  p->cam_beta  = -1.0;
}

const xc_func_info_type_cuda xc_func_info_hyb_gga_xc_lcy_pbe = {
