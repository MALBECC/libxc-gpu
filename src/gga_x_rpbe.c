...
static void 
gga_x_rpbe_init(xc_func_type_cuda *p)
{
...
void 
xc_gga_x_rpbe_set_params(xc_func_type_cuda *p, double kappa, double mu)
{
...
const xc_func_info_type_cuda xc_func_info_gga_x_rpbe = {
  XC_GGA_X_RPBE,
  XC_EXCHANGE,
