...
void
xc_hyb_gga_xc_b1wc_init(xc_func_type_cuda *p)
{
  static int   funcs_id  [2] = {XC_GGA_X_WC, XC_GGA_C_PBE_cuda};
...
const xc_func_info_type_cuda xc_func_info_hyb_gga_xc_b1wc = {
  XC_HYB_GGA_XC_B1WC,
...
void
xc_hyb_gga_xc_b1lyp_init(xc_func_type_cuda *p)
{
...
const xc_func_info_type_cuda xc_func_info_hyb_gga_xc_b1lyp = {
  XC_HYB_GGA_XC_B1LYP,
  XC_EXCHANGE_CORRELATION,
  "B1LYP",
  XC_FAMILY_HYB_GGA,
...
void
xc_hyb_gga_xc_b1pw91_init(xc_func_type_cuda *p)
{
...
const xc_func_info_type_cuda xc_func_info_hyb_gga_xc_b1pw91 = {
...
void
xc_hyb_gga_xc_mpw1pw_init(xc_func_type_cuda *p)
{
...
const xc_func_info_type_cuda xc_func_info_hyb_gga_xc_mpw1lyp = {
...
const xc_func_info_type_cuda xc_func_info_hyb_gga_xc_mpw1pbe = {
...
const xc_func_info_type_cuda xc_func_info_hyb_gga_xc_mpw1pw = {
...
void
xc_hyb_gga_xc_mpw1k_init(xc_func_type_cuda *p)
{
...
const xc_func_info_type_cuda xc_func_info_hyb_gga_xc_mpw1k = {
  XC_HYB_GGA_XC_MPW1K,
  XC_EXCHANGE_CORRELATION,
  "mPW1K",
  XC_FAMILY_HYB_GGA,
...
void
xc_hyb_gga_xc_bhandh_init(xc_func_type_cuda *p)
{
...
const xc_func_info_type_cuda xc_func_info_hyb_gga_xc_bhandh = {
...
void
xc_hyb_gga_xc_bhandhlyp_init(xc_func_type_cuda *p)
{
  static int   funcs_id  [2] = {XC_GGA_X_B88, XC_GGA_C_LYP};
  static double funcs_coef[2] = {0.5, 1.0};
...
const xc_func_info_type_cuda xc_func_info_hyb_gga_xc_bhandhlyp = {
...
void
xc_hyb_gga_xc_mpwlyp1m_init(xc_func_type_cuda *p)
{
...
const xc_func_info_type_cuda xc_func_info_hyb_gga_xc_mpwlyp1m = {
