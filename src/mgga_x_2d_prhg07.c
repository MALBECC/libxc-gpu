...
static void 
func(const xc_func_type_cuda *p, xc_mgga_work_x_t *r)
{
  double y;
  double v_PRHG, C;
...
const xc_func_info_type_cuda xc_func_info_mgga_x_2d_prhg07 = {
  XC_MGGA_X_2D_PRHG07,
  XC_EXCHANGE,
...
const xc_func_info_type_cuda xc_func_info_mgga_x_2d_prhg07_prp10 = {
