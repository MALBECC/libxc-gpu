...
extern "C" __device__ inline static void 
xc_mgga_x_tpss_enhance(const xc_func_type_cuda *pt, xc_mgga_work_x_t *r)
{
  ...
  assert(pt->params_gpu != NULL);
  params = (mgga_x_tpss_params * ) (pt->params_gpu);
