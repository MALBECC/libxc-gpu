...
__device__ void func0(const xc_func_type_cuda *p, xc_lda_work_t *r)
{
  //printf("func0(...)\n");
  ...
  params = (lda_c_1d_csc_params * )(p->params_gpu);

  t1 = params->para_gpu[4];
  t2 = r->rs * r->rs;
  t4 = t1 * t2 + r->rs;
  t5 = params->para_gpu[7];
  t8 = params->para_gpu[9];
  t9 = pow(r->rs, t8);
  t10 = params->para_gpu[8] * t9;
  t11 = t5 * r->rs + t10 + 0.1e1;
  t12 = log(t11);
  t13 = t4 * t12;
  t15 = params->para_gpu[1];
  t18 = params->para_gpu[5];
  t19 = pow(r->rs, t18);
  t20 = params->para_gpu[2] * t19;
  t22 = params->para_gpu[6];
  t23 = pow(r->rs, t22);
  t24 = params->para_gpu[3] * t23;
  t26 = 0.2e1 * t15 * r->rs + 0.2e1 * t20 + 0.2e1 * t24 + 0.2e1 * params->para_gpu[0];
  t27 = 0.1e1 / t26;
  r->f = -t13 * t27;
...
__device__ void func1(const xc_func_type_cuda *p, xc_lda_work_t *r)
{
  //printf("func1(...)\n");
  ...
  t27 = 0.1e1 / t26;
  t28 = t13 * t27;
  t29 = params->ferro_gpu[4];
  t31 = t29 * t2 + r->rs;
  t32 = params->ferro_gpu[7];
  t35 = params->ferro_gpu[9];
  t36 = pow(r->rs, t35);
  t37 = params->ferro_gpu[8] * t36;
  t38 = t32 * r->rs + t37 + 0.1e1;
  t39 = log(t38);
  t40 = t31 * t39;
  t42 = params->ferro_gpu[1];
  t45 = params->ferro_gpu[5];
  t46 = pow(r->rs, t45);
  t47 = params->ferro_gpu[2] * t46;
  t49 = params->ferro_gpu[6];
  t50 = pow(r->rs, t49);
  t51 = params->ferro_gpu[3] * t50;
  t53 = 0.2e1 * t42 * r->rs + 0.2e1 * t47 + 0.2e1 * t51 + 0.2e1 * params->ferro_gpu[0];
  t54 = 0.1e1 / t53;
  t56 = -t40 * t54 + t28;
  t57 = r->z * r->z;
  r->f = t56 * t57 - t28;
...
extern "C" __device__ inline void xc_lda_c_1d_csc_func(const xc_func_type_cuda *p, xc_lda_work_t *r)
{
