...
/*
extern "C" __device__ inline void xc_gga_x_pbe_enhance
  (const xc_func_type_cuda *p,  xc_gga_work_x_t *r)
{
  //printf("xc_gga_work_x_t()");
  __shared__ double t1, t2, t3, t4, t5, t6, t7, t11;
  __shared__ double t16, t17, t19, t27, t28, t29, t32;
  //double t39, t43;

  __shared__ gga_x_pbe_params *params;

  //assert(p->params != NULL);
  //params = (gga_x_pbe_params * )(p->params);
  assert(p->params_gpu != NULL);
  params = (gga_x_pbe_params*)(p->params_gpu);
...
{
  //printf("xc_gga_work_x_t()");
  __shared__ double t1, t2, t3, t4, t5, t6;
  double t7, t11;
  __shared__ double t16;
  double t17, t19;
  __shared__ double t27;
  double t28;
  __shared__ double t29, t32;
  __shared__ double t39, t43;
