...
static void 
gga_xc_wb97_init(xc_func_type_cuda *p)
{
...
const xc_func_info_type_cuda xc_func_info_hyb_gga_xc_wb97 = {
  XC_HYB_GGA_XC_WB97,
...
const xc_func_info_type_cuda xc_func_info_hyb_gga_xc_wb97x = {
  XC_HYB_GGA_XC_WB97X,
  XC_EXCHANGE_CORRELATION,
...
const xc_func_info_type_cuda xc_func_info_hyb_gga_xc_wb97x_v = {
...
const xc_func_info_type_cuda xc_func_info_hyb_gga_xc_wb97x_d = {
