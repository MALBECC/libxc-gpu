...
CC_FORTRAN_INT FC_FUNC(xc_f90_info_number, XC_F90_INFO_NUMBER)
     (void **info)
{
  return (CC_FORTRAN_INT) ((xc_func_info_type_cuda *)(*info))->number;
}
...
CC_FORTRAN_INT FC_FUNC(xc_f90_info_kind, XC_F90_INFO_KIND)
     (void **info)
{
  return (CC_FORTRAN_INT) ((xc_func_info_type_cuda *)(*info))->kind;
}
...
{
  TO_F_STR1(((xc_func_info_type_cuda *)(*info))->name, s);
}
...
CC_FORTRAN_INT  FC_FUNC(xc_f90_info_family, XC_F90_INFO_FAMILY)
     (void **info)
{
  return (CC_FORTRAN_INT) ((xc_func_info_type_cuda *)(*info))->family;
}
...
CC_FORTRAN_INT  FC_FUNC(xc_f90_info_flags, XC_F90_INFO_FLAGS)
     (void **info)
{
  return (CC_FORTRAN_INT) ((xc_func_info_type_cuda *)(*info))->flags;
}
...
{
  xc_func_info_type_cuda *func_p = (xc_func_info_type_cuda *)(*info);
...
{
  return (CC_FORTRAN_INT) xc_family_from_id_cuda((int) (*functional), NULL, NULL);
}
...
{
  xc_func_type_cuda *func_p;
  
  func_p = (xc_func_type_cuda *)malloc(sizeof(xc_func_type_cuda));
  xc_func_init_cuda(func_p, (int) (*functional), (int) (*nspin));
...
void FC_FUNC(xc_f90_func_end, XC_F90_FUNC_END)
     (void **p)
{
  xc_func_end_cuda((xc_func_type_cuda *)(*p));
  free(*p);
  *p = NULL;
}
...
{
  xc_func_set_dens_threshold_cuda((xc_func_type_cuda *)(*p), *dens_threshold);
}

void FC_FUNC(xc_f90_func_set_ext_params, XC_F90_FUNC_SET_EXT_PARAMS)
     (void **p, double *ext_params)
{
  xc_func_set_ext_params_cuda((xc_func_type_cuda *)(*p), ext_params);
}
...
{
  xc_lda_cuda((xc_func_type_cuda *)(*p), *np, rho, zk, vrho, v2rho2, v3rho3);
}
...
void FC_FUNC(xc_f90_lda_exc, XC_F90_LDA_EXC)
     (void **p, CC_FORTRAN_INT *np, double *rho,
      double *zk)
{
  xc_lda_cuda((xc_func_type_cuda *)(*p), *np, rho, zk, NULL, NULL, NULL);
}
...
{
  xc_lda_cuda((xc_func_type_cuda *)(*p), *np, rho, zk, vrho, NULL, NULL);
}
...
void FC_FUNC(xc_f90_lda_vxc, XC_F90_LDA_VXC)
     (void **p, CC_FORTRAN_INT *np, double *rho, 
      double *vrho)
{
  xc_lda_cuda((xc_func_type_cuda *)(*p), *np, rho, NULL, vrho, NULL, NULL);
}
...
{
  xc_lda_cuda((xc_func_type_cuda *)(*p), *np, rho, NULL, vrho, v2rho2, NULL);
}
...
void FC_FUNC(xc_f90_lda_fxc, XC_F90_LDA_FXC)
     (void **p, CC_FORTRAN_INT *np, double *rho,
      double *v2rho2)
{
  xc_lda_cuda((xc_func_type_cuda *)(*p), *np, rho, NULL, NULL, v2rho2, NULL);
}
...
void FC_FUNC(xc_f90_lda_kxc, XC_F90_LDA_KXC)
     (void **p, CC_FORTRAN_INT *np, double *rho,
      double *v3rho3)
{
  xc_lda_cuda((xc_func_type_cuda *)(*p), *np, rho, NULL, NULL, NULL, v3rho3);
}
...
{
  xc_gga((xc_func_type_cuda *)(*p), *np, rho, sigma, zk, vrho, vsigma, 
...
void FC_FUNC(xc_f90_gga_exc, XC_F90_GGA_EXC)
     (void **p, CC_FORTRAN_INT *np, double *rho, double *sigma, 
      double *zk)
{
  xc_gga((xc_func_type_cuda *)(*p), *np, rho, sigma, zk, NULL, NULL, 
...
{
  xc_gga((xc_func_type_cuda *)(*p), *np, rho, sigma, NULL, vrho, vsigma, 
	  NULL, NULL, NULL, NULL, NULL, NULL, NULL);
}
...
void FC_FUNC(xc_f90_gga_fxc, XC_F90_GGA_FXC)
     (void **p, CC_FORTRAN_INT *np, double *rho, double *sigma, 
      double *v2rho2, double *v2rhosigma, double *v2sigma2)
{
  xc_gga((xc_func_type_cuda *)(*p), *np, rho, sigma, NULL, NULL, NULL, 
	  v2rho2, v2rhosigma, v2sigma2, NULL, NULL, NULL, NULL);
}
...
{
  xc_gga_lb_modified_cuda((xc_func_type_cuda *)(*p), *np, rho, sigma, *r, vrho);
}
...
{
  xc_mgga_cuda((xc_func_type_cuda *)(*p), *np, rho, sigma, lapl, tau, 
