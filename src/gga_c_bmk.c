...
static void 
gga_c_bmk_init(xc_func_type_cuda *p)
{
...
const xc_func_info_type_cuda xc_func_info_gga_c_n12 = {
  XC_GGA_C_N12,
  XC_CORRELATION,
...
const xc_func_info_type_cuda xc_func_info_gga_c_n12_sx = {
  XC_GGA_C_N12_SX,
  XC_CORRELATION,
...
const xc_func_info_type_cuda xc_func_info_gga_c_gam = {
  XC_GGA_C_GAM,
  XC_CORRELATION,
...
const xc_func_info_type_cuda xc_func_info_gga_c_bmk = {
  XC_GGA_C_BMK,
  XC_CORRELATION,
...
const xc_func_info_type_cuda xc_func_info_gga_c_tau_hcth = {
  XC_GGA_C_TAU_HCTH,
  XC_CORRELATION,
...
const xc_func_info_type_cuda xc_func_info_gga_c_hyb_tau_hcth = {
