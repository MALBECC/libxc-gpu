...
static void
gga_xc_vv10_init(xc_func_type_cuda *p)
{
  static int   funcs_id  [2] = {XC_GGA_X_RPW86, XC_GGA_C_PBE_cuda};
...
static void
hyb_gga_xc_lc_vv10_init(xc_func_type_cuda *p)
{
...
const xc_func_info_type_cuda xc_func_info_gga_xc_vv10 = {
  XC_GGA_XC_VV10,
...
const xc_func_info_type_cuda xc_func_info_hyb_gga_xc_lc_vv10 = {
