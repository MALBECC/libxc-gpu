...
const xc_func_info_type_cuda xc_func_info_gga_x_cap = {
  XC_GGA_X_CAP,
  XC_EXCHANGE,
...
void
xc_hyb_gga_xc_cap0_init(xc_func_type_cuda *p)
{
  static int   funcs_id  [2] = {XC_GGA_X_CAP, XC_GGA_C_PBE_cuda};
...
const xc_func_info_type_cuda xc_func_info_hyb_gga_xc_cap0 = {
  XC_HYB_GGA_XC_CAP0,
