...
const xc_func_info_type_cuda xc_func_info_mgga_c_scan = {
  XC_MGGA_C_SCAN,
  XC_CORRELATION,
...
static void
mgga_c_scan_rvv10_init(xc_func_type_cuda *p)
{
...
const xc_func_info_type_cuda xc_func_info_mgga_c_scan_rvv10 = {
