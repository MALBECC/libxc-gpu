...
static void
mgga_x_m05_init(xc_func_type_cuda *p)
{
...
const xc_func_info_type_cuda xc_func_info_hyb_mgga_x_m05 = {
  XC_HYB_MGGA_X_M05,
  XC_EXCHANGE,
...
const xc_func_info_type_cuda xc_func_info_hyb_mgga_x_m05_2x = {
...
const xc_func_info_type_cuda xc_func_info_hyb_mgga_x_m06_2x = {
