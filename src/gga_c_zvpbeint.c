...
static void 
gga_c_zvpbeint_init(xc_func_type_cuda *p)
{
...
const xc_func_info_type_cuda xc_func_info_gga_c_zvpbeint = {
  XC_GGA_C_ZVPBEINT,
  XC_CORRELATION,
...
const xc_func_info_type_cuda xc_func_info_gga_c_zvpbesol = {
  XC_GGA_C_ZVPBESOL,
  XC_CORRELATION,
