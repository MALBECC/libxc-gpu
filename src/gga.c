...
*/
void xc_gga_cuda(const xc_func_type_cuda *func, int np, const double *rho, const double *sigma,
	     ...
	     double *v3rho3, double *v3rho2sigma, double *v3rhosigma2, double *v3sigma3)
{
  ...
  /* We omit this step since the data is in cuda memory.
  if(zk != NULL)
...
//returns only energy
inline void 
xc_gga_exc_cuda(const xc_func_type_cuda *p, int np, const double *rho, const double *sigma, 
	    double *zk)
{
...
inline void 
xc_gga_vxc_cuda(const xc_func_type_cuda *p, int np, const double *rho, const double *sigma,
...
inline void 
xc_gga_exc_vxc_cuda(const xc_func_type_cuda *p, int np, const double *rho, const double *sigma,
		double *zk, double *vrho, double *vsigma)
{
...
inline void 
xc_gga_fxc_cuda(const xc_func_type_cuda *p, int np, const double *rho, const double *sigma,
	    double *v2rho2, double *v2rhosigma, double *v2sigma2)
{
...
inline void 
xc_gga_kxc_cuda(const xc_func_type_cuda *p, int np, const double *rho, const double *sigma,
	    double *v3rho3, double *v3rho2sigma, double *v3rhosigma2, double *v3sigma3)
{
