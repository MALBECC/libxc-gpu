...
static void 
gga_x_b86_init(xc_func_type_cuda *p)
{
  double mu, kappa;
...
void 
xc_gga_x_b86_set_params(xc_func_type_cuda *p, double beta, double gamma, double omega)
{
...
const xc_func_info_type_cuda xc_func_info_gga_x_b86 = {
  XC_GGA_X_B86,
  XC_EXCHANGE,
  "Becke 86",
  XC_FAMILY_GGA,
...
const xc_func_info_type_cuda xc_func_info_gga_x_b86_mgc = {
  XC_GGA_X_B86_MGC,
  XC_EXCHANGE,
...
const xc_func_info_type_cuda xc_func_info_gga_x_b86_r = {
  XC_GGA_X_B86_R,
  XC_EXCHANGE,
