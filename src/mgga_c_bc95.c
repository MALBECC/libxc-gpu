...
static void 
mgga_c_bc95_init(xc_func_type_cuda *p)
{
...
void 
xc_mgga_c_bc95_set_params(xc_func_type_cuda *p, double css, double copp)
{
...
const xc_func_info_type_cuda xc_func_info_mgga_c_bc95 = {
  XC_MGGA_C_BC95,
  XC_CORRELATION,
