...
static void 
lda_c_pz_init(xc_func_type_cuda *p)
{
...
const xc_func_info_type_cuda xc_func_info_lda_c_pz = {
  XC_LDA_C_PZ,
  XC_CORRELATION,
  "Perdew & Zunger",
  XC_FAMILY_LDA,
...
const xc_func_info_type_cuda xc_func_info_lda_c_pz_mod = {
  XC_LDA_C_PZ_MOD,
  XC_CORRELATION,
...
const xc_func_info_type_cuda xc_func_info_lda_c_ob_pz = {
  XC_LDA_C_OB_PZ,
  XC_CORRELATION,
