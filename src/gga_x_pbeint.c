...
void 
xc_gga_x_pbeint_set_params(xc_func_type_cuda *p, double kappa, double alpha, double muPBE, double muGE)
{
  gga_x_pbeint_params *params;
...
const xc_func_info_type_cuda xc_func_info_gga_x_pbeint = {
  XC_GGA_X_PBEINT,
  XC_EXCHANGE,
...
const xc_func_info_type_cuda xc_func_info_gga_k_apbeint = {
  XC_GGA_K_APBEINT,
  XC_KINETIC,
...
const xc_func_info_type_cuda xc_func_info_gga_k_revapbeint = {
  XC_GGA_K_REVAPBEINT,
  XC_KINETIC,
