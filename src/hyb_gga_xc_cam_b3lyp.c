...
void
xc_hyb_gga_xc_cam_b3lyp_init(xc_func_type_cuda *p)
{
...
const xc_func_info_type_cuda xc_func_info_hyb_gga_xc_cam_b3lyp = {
...
const xc_func_info_type_cuda xc_func_info_hyb_gga_xc_tuned_cam_b3lyp = {
...
const xc_func_info_type_cuda xc_func_info_hyb_gga_xc_cam_qtp_01 = {
