...
static void 
lda_c_wigner_init(xc_func_type_cuda *p)
{
...
const xc_func_info_type_cuda xc_func_info_lda_c_wigner = {
  XC_LDA_C_WIGNER,
  XC_CORRELATION,
  "Wigner",
  XC_FAMILY_LDA,
...
const xc_func_info_type_cuda xc_func_info_lda_xc_lp_a = {
  XC_LDA_XC_LP_A,
...
const xc_func_info_type_cuda xc_func_info_lda_xc_lp_b = {
  XC_LDA_XC_LP_B,
  XC_EXCHANGE_CORRELATION,
...
const xc_func_info_type_cuda xc_func_info_lda_c_mcweeny = {
  XC_LDA_C_MCWEENY,
  XC_CORRELATION,
  "McWeeny 76",
  XC_FAMILY_LDA,
...
const xc_func_info_type_cuda xc_func_info_lda_c_br78 = {
  XC_LDA_C_BR78,
  XC_CORRELATION,
  "Brual & Rothstein 78",
  XC_FAMILY_LDA,
...
const xc_func_info_type_cuda xc_func_info_lda_c_ow_lyp = {
  XC_LDA_C_OW_LYP,
  XC_CORRELATION,
...
const xc_func_info_type_cuda xc_func_info_lda_c_ow = {
  XC_LDA_C_OW,
  XC_CORRELATION,
  "Optimized Wigner",
  XC_FAMILY_LDA,
