...
static void
mgga_x_m06l_init(xc_func_type_cuda *p)
{
...
const xc_func_info_type_cuda xc_func_info_mgga_x_m06_l = {
  XC_MGGA_X_M06_L,
  XC_EXCHANGE,
...
const xc_func_info_type_cuda xc_func_info_hyb_mgga_x_m06_hf = {
...
const xc_func_info_type_cuda xc_func_info_hyb_mgga_x_m06 = {
  XC_HYB_MGGA_X_M06,
  XC_EXCHANGE,
...
const xc_func_info_type_cuda xc_func_info_mgga_x_revm06_l = {
  XC_MGGA_X_REVM06_L,
  XC_EXCHANGE,
