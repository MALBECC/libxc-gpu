...
static void 
gga_x_pw91_init(xc_func_type_cuda *p)
{
...
void 
xc_gga_x_pw91_set_params(xc_func_type_cuda *p, double a, double b, double c, double d, double f, double alpha, double expo)
{
...
void 
xc_gga_x_pw91_set_params2(xc_func_type_cuda *p, double bt, double alpha, double expo)
{
  double beta;
  double a, b, c, d, f;
...
const xc_func_info_type_cuda xc_func_info_gga_x_pw91 = {
  XC_GGA_X_PW91,
  XC_EXCHANGE,
  "Perdew & Wang 91",
  XC_FAMILY_GGA,
...
const xc_func_info_type_cuda xc_func_info_gga_x_mpw91 = {
  XC_GGA_X_MPW91,
  XC_EXCHANGE,
...
const xc_func_info_type_cuda xc_func_info_gga_k_lc94 = {
  XC_GGA_K_LC94,
  XC_KINETIC,
  "Lembarki & Chermette",
  XC_FAMILY_GGA,
