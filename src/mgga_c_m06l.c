...
static void 
mgga_c_vsxc_init(xc_func_type_cuda *p)
{
  ...
  xc_func_init_cuda(p->func_aux[0], XC_LDA_C_PW_MOD, XC_POLARIZED);
...
const xc_func_info_type_cuda xc_func_info_mgga_c_m06_l = {
  XC_MGGA_C_M06_L,
  XC_CORRELATION,
...
const xc_func_info_type_cuda xc_func_info_mgga_c_m06_hf = {
  XC_MGGA_C_M06_HF,
  XC_CORRELATION,
...
const xc_func_info_type_cuda xc_func_info_mgga_c_m06 = {
  XC_MGGA_C_M06,
  XC_CORRELATION,
...
const xc_func_info_type_cuda xc_func_info_mgga_c_m06_2x = {
  XC_MGGA_C_M06_2X,
  XC_CORRELATION,
...
const xc_func_info_type_cuda xc_func_info_mgga_c_revm06_l = {
  XC_MGGA_C_REVM06_L,
  XC_CORRELATION,
