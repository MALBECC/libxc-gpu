...
static func_params_type_cuda ext_params_hse03[] = {
...
static void
hyb_gga_xc_hse_init(xc_func_type_cuda *p)
{
  int   funcs_id  [3] = {XC_GGA_X_WPBEH, XC_GGA_X_WPBEH, XC_GGA_C_PBE_cuda};
...
const xc_func_info_type_cuda xc_func_info_hyb_gga_xc_hse03 = {
  XC_HYB_GGA_XC_HSE03,
...
const xc_func_info_type_cuda xc_func_info_hyb_gga_xc_hse06 = {
  XC_HYB_GGA_XC_HSE06,
  XC_EXCHANGE_CORRELATION,
  "HSE06",
  XC_FAMILY_HYB_GGA,
...
const xc_func_info_type_cuda xc_func_info_hyb_gga_xc_hse12 = {
  XC_HYB_GGA_XC_HSE12,
  XC_EXCHANGE_CORRELATION,
  "HSE12",
  XC_FAMILY_HYB_GGA,
...
const xc_func_info_type_cuda xc_func_info_hyb_gga_xc_hse12s = {
...
static void
hyb_gga_xc_hse_sol_init(xc_func_type_cuda *p)
{
  int   funcs_id  [3] = {XC_GGA_X_HJS_PBE_SOL, XC_GGA_X_HJS_PBE_SOL, XC_GGA_C_PBE_cuda};
...
const xc_func_info_type_cuda xc_func_info_hyb_gga_xc_hse_sol = {
...
static void
hyb_gga_xc_lc_wpbe_init(xc_func_type_cuda *p)
{
  static int   funcs_id  [2] = {XC_GGA_X_WPBEH, XC_GGA_C_PBE_cuda};
...
const xc_func_info_type_cuda xc_func_info_hyb_gga_xc_lc_wpbe = {
...
static void
hyb_gga_xc_lrc_wpbeh_init(xc_func_type_cuda *p)
{
  static int   funcs_id  [2] = {XC_GGA_X_HJS_PBE, XC_GGA_C_PBE_cuda};
...
static void
hyb_gga_xc_lrc_wpbe_init(xc_func_type_cuda *p)
{
  static int   funcs_id  [2] = {XC_GGA_X_HJS_PBE, XC_GGA_C_PBE_cuda};
  static double funcs_coef[2] = {1.0, 1.0};
...
const xc_func_info_type_cuda xc_func_info_hyb_gga_xc_lrc_wpbeh = {
...
const xc_func_info_type_cuda xc_func_info_hyb_gga_xc_lrc_wpbe = {
...
static void
hyb_gga_xc_hjs_init(xc_func_type_cuda *p)
{
  static int   funcs_id  [3] = {-1, -1, XC_GGA_C_PBE_cuda};
...
const xc_func_info_type_cuda xc_func_info_hyb_gga_xc_hjs_pbe = {
...
const xc_func_info_type_cuda xc_func_info_hyb_gga_xc_hjs_pbe_sol = {
...
const xc_func_info_type_cuda xc_func_info_hyb_gga_xc_hjs_b88 = {
...
const xc_func_info_type_cuda xc_func_info_hyb_gga_xc_hjs_b97x = {
