   ...
   double *v2sigmalapl, double *v2sigmatau, double *v2lapltau)
{
  ...
  for(ii=0; ii<func->n_func_aux; ii++){
    ...
    case XC_FAMILY_LDA:
      //xc_lda_cuda(aux, np, rho, zk_, vrho_, v2rho2_, NULL);
      break;
    case XC_FAMILY_GGA:
      xc_gga_cuda(aux, np, rho, sigma, zk_, vrho_, vsigma_, v2rho2_, v2rhosigma_, v2sigma2_, NULL, NULL, NULL, NULL);
      break;
    case XC_FAMILY_MGGA:
      xc_mgga_cuda(aux, np, rho, sigma, lapl, tau, zk_, vrho_, vsigma_, vlapl_, vtau_,
