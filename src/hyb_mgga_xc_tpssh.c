...
static void
hyb_mgga_xc_tpssh_init(xc_func_type_cuda *p)
{
...
const xc_func_info_type_cuda xc_func_info_hyb_mgga_xc_tpssh = {
...
static void
hyb_mgga_xc_revtpssh_init(xc_func_type_cuda *p)
{
...
const xc_func_info_type_cuda xc_func_info_hyb_mgga_xc_revtpssh = {
