...
static void
gga_xc_edf1_init(xc_func_type_cuda *p)
{
...
const xc_func_info_type_cuda xc_func_info_gga_xc_edf1 = {
  XC_GGA_XC_EDF1,
...
static void
gga_x_optpbe_vdw_init(xc_func_type_cuda *p)
{
  static int   funcs_id  [2] = {XC_GGA_X_PBE_cuda, XC_GGA_X_RPBE};
...
const xc_func_info_type_cuda xc_func_info_gga_x_optpbe_vdw = {
  XC_GGA_X_OPTPBE_VDW,
  XC_EXCHANGE,
...
static void
gga_xc_mohlyp_init(xc_func_type_cuda *p)
{
...
const xc_func_info_type_cuda xc_func_info_gga_xc_mohlyp = {
  XC_GGA_XC_MOHLYP,
  XC_EXCHANGE_CORRELATION,
...
static void
gga_xc_mohlyp2_init(xc_func_type_cuda *p)
{
...
const xc_func_info_type_cuda xc_func_info_gga_xc_mohlyp2 = {
  XC_GGA_XC_MOHLYP2,
  XC_EXCHANGE_CORRELATION,
...
static void
gga_x_sogga_init(xc_func_type_cuda *p)
{
  static int   funcs_id  [2] = {XC_GGA_X_PBE_cuda, XC_GGA_X_RPBE};
...
const xc_func_info_type_cuda xc_func_info_gga_x_sogga = {
  XC_GGA_X_SOGGA,
  XC_EXCHANGE,
