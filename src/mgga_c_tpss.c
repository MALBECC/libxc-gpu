...
static void 
mgga_c_tpss_init(xc_func_type_cuda *p)
{
...
xc_mgga_c_tpss_set_params
     (xc_func_type_cuda *p, double beta, double d, double C0_0, double C0_1, double C0_2, double C0_3)
{
...
const xc_func_info_type_cuda xc_func_info_mgga_c_tpss = {
  XC_MGGA_C_TPSS,
  XC_CORRELATION,
