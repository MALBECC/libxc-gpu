...
static void 
gga_k_dk_init(xc_func_type_cuda *p)
{
  int i;
  double ff, *aa, *bb;
...
const xc_func_info_type_cuda xc_func_info_gga_k_dk = {
  XC_GGA_K_DK,
  XC_KINETIC,
  "DePristo and Kress",
  XC_FAMILY_GGA,
...
const xc_func_info_type_cuda xc_func_info_gga_k_perdew = {
  XC_GGA_K_PERDEW,
  XC_KINETIC,
  "Perdew",
  XC_FAMILY_GGA,
...
const xc_func_info_type_cuda xc_func_info_gga_k_vsk = {
  XC_GGA_K_VSK,
  XC_KINETIC,
...
const xc_func_info_type_cuda xc_func_info_gga_k_vjks = {
  XC_GGA_K_VJKS,
  XC_KINETIC,
...
const xc_func_info_type_cuda xc_func_info_gga_k_ernzerhof = {
  XC_GGA_K_ERNZERHOF,
  XC_KINETIC,
  "Ernzerhof",
  XC_FAMILY_GGA,
