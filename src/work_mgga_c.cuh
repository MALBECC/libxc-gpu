...
kernel_work_mgga_c (const xc_func_type_cuda *p, int np, const double *rho, const double *sigma, const double *lapl, const double *tau,
...
work_mgga_c (const xc_func_type_cuda *p, int np, const double *rho, const double *sigma, const double *lapl, const double *tau,
	    double *zk, double *vrho, double *vsigma, double *vlapl, double *vtau,
	    double *v2rho2, double *v2sigma2, double *v2lapl2, double *v2tau2,
	    double *v2rhosigma, double *v2rholapl, double *v2rhotau, 
	    double *v2sigmalapl, double *v2sigmatau, double *v2lapltau)
{
    ...
    kernel_work_mgga_c <<<blocksPerGrid, threadsPerBlock>>> (
	pCUDA, np, rho, sigma, lapl, tau,
