...
static void 
lda_x_init(xc_func_type_cuda *p)
{
  lda_x_params *params;
...
const xc_func_info_type_cuda xc_func_info_lda_x = {
  XC_LDA_X,
  XC_EXCHANGE,
  "Slater exchange",
  XC_FAMILY_LDA,
...
const xc_func_info_type_cuda xc_func_info_lda_c_xalpha = {
  XC_LDA_C_XALPHA,
  XC_CORRELATION,
  "Slater's Xalpha",
  XC_FAMILY_LDA,
...
const xc_func_info_type_cuda xc_func_info_lda_x_rae = {
  XC_LDA_X_RAE,
  XC_EXCHANGE,
