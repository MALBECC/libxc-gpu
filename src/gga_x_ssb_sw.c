...
static void 
gga_x_ssb_sw_init(xc_func_type_cuda *p)
{
...
void 
xc_gga_x_ssb_sw_set_params(xc_func_type_cuda *p, double A, double B, double C, double D, double E)
{
...
const xc_func_info_type_cuda xc_func_info_gga_x_ssb_sw = {
  XC_GGA_X_SSB_SW,
  XC_EXCHANGE,
...
static void
gga_x_ssb_init(xc_func_type_cuda *p)
{
...
const xc_func_info_type_cuda xc_func_info_gga_x_ssb = {
  XC_GGA_X_SSB,
  XC_EXCHANGE,
...
static void
gga_x_ssb_d_init(xc_func_type_cuda *p)
{
...
const xc_func_info_type_cuda xc_func_info_gga_x_ssb_d = {
  XC_GGA_X_SSB_D,
  XC_EXCHANGE,
