...
static void
gga_x_hjs_init(xc_func_type_cuda *p)
{
...
void 
xc_gga_x_hjs_set_params(xc_func_type_cuda *p, double omega)
{
...
const xc_func_info_type_cuda xc_func_info_gga_x_hjs_pbe = {
  XC_GGA_X_HJS_PBE,
  XC_EXCHANGE,
...
const xc_func_info_type_cuda xc_func_info_gga_x_hjs_pbe_sol = {
...
const xc_func_info_type_cuda xc_func_info_gga_x_hjs_b88 = {
  XC_GGA_X_HJS_B88,
  XC_EXCHANGE,
...
const xc_func_info_type_cuda xc_func_info_gga_x_hjs_b97x = {
  XC_GGA_X_HJS_B97X,
  XC_EXCHANGE,
