...
const xc_func_info_type_cuda xc_func_info_mgga_c_kcis = {
  XC_MGGA_C_KCIS,
  XC_CORRELATION,
...
/*************************************************************/
void
xc_hyb_mgga_xc_b0kcis_init(xc_func_type_cuda *p)
{
...
const xc_func_info_type_cuda xc_func_info_hyb_mgga_xc_b0kcis = {
