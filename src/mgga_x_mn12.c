...
static void
mgga_x_mn12_init(xc_func_type_cuda *p)
{
...
const xc_func_info_type_cuda xc_func_info_mgga_x_mn12_l = {
  XC_MGGA_X_MN12_L,
  XC_EXCHANGE,
...
const xc_func_info_type_cuda xc_func_info_hyb_mgga_x_mn12_sx = {
...
const xc_func_info_type_cuda xc_func_info_mgga_x_mn15_l = {
  XC_MGGA_X_MN15_L,
  XC_EXCHANGE,
...
const xc_func_info_type_cuda xc_func_info_hyb_mgga_x_mn15 = {
  XC_HYB_MGGA_X_MN15,
  XC_EXCHANGE,
