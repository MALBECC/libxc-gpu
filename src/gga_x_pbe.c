...
//#define XC_GGA_X_PBE_cuda          101 /* Perdew, Burke & Ernzerhof exchange             */
...
#include "work_gga_x_cuda.c"
#include "work_gga_x_cuda.cuh"

const xc_func_info_type_cuda xc_func_info_gga_x_pbe = {
  XC_GGA_X_PBE_cuda,
  XC_EXCHANGE,
...
const xc_func_info_type_cuda xc_func_info_gga_x_pbe_r = {
  XC_GGA_X_PBE_R,
  XC_EXCHANGE,
...
const xc_func_info_type_cuda xc_func_info_gga_x_pbe_sol = {
  XC_GGA_X_PBE_SOL,
  XC_EXCHANGE,
...
const xc_func_info_type_cuda xc_func_info_gga_x_xpbe = {
  XC_GGA_X_XPBE,
  XC_EXCHANGE,
...
const xc_func_info_type_cuda xc_func_info_gga_x_pbe_jsjr = {
  XC_GGA_X_PBE_JSJR,
  XC_EXCHANGE,
...
const xc_func_info_type_cuda xc_func_info_gga_x_pbek1_vdw = {
  XC_GGA_X_PBEK1_VDW,
  XC_EXCHANGE,
...
const xc_func_info_type_cuda xc_func_info_gga_x_apbe = {
  XC_GGA_X_APBE,
  XC_EXCHANGE,
...
const xc_func_info_type_cuda xc_func_info_gga_x_pbe_tca = {
  XC_GGA_X_PBE_TCA,
  XC_EXCHANGE,
...
const xc_func_info_type_cuda xc_func_info_gga_x_lambda_lo_n = {
...
const xc_func_info_type_cuda xc_func_info_gga_x_lambda_ch_n = {
...
const xc_func_info_type_cuda xc_func_info_gga_x_lambda_oc2_n = {
...
const xc_func_info_type_cuda xc_func_info_gga_x_pbe_mol = {
  XC_GGA_X_PBE_MOL,
  XC_EXCHANGE,
...
const xc_func_info_type_cuda xc_func_info_gga_x_bcgp = {
  XC_GGA_X_BCGP,
  XC_EXCHANGE,
...
const xc_func_info_type_cuda xc_func_info_gga_x_pbefe = {
  XC_GGA_X_PBEFE,
  XC_EXCHANGE,
...
const xc_func_info_type_cuda xc_func_info_gga_k_apbe = {
  XC_GGA_K_APBE,
  XC_KINETIC,
  "mu fixed from the semiclassical neutral atom",
  XC_FAMILY_GGA,
...
const xc_func_info_type_cuda xc_func_info_gga_k_revapbe = {
  XC_GGA_K_REVAPBE,
  XC_KINETIC,
  "revised APBE",
  XC_FAMILY_GGA,
...
const xc_func_info_type_cuda xc_func_info_gga_k_tw1 = {
  XC_GGA_K_TW1,
  XC_KINETIC,
...
const xc_func_info_type_cuda xc_func_info_gga_k_tw2 = {
  XC_GGA_K_TW2,
  XC_KINETIC,
...
const xc_func_info_type_cuda xc_func_info_gga_k_tw3 = {
  XC_GGA_K_TW3,
  XC_KINETIC,
...
const xc_func_info_type_cuda xc_func_info_gga_k_tw4 = {
  XC_GGA_K_TW4,
  XC_KINETIC,
