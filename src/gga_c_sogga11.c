...
static void 
gga_c_sogga11_init(xc_func_type_cuda *p)
{
...
const xc_func_info_type_cuda xc_func_info_gga_c_sogga11 = {
  XC_GGA_C_SOGGA11,
  XC_CORRELATION,
...
const xc_func_info_type_cuda xc_func_info_gga_c_sogga11_x = {
  XC_GGA_C_SOGGA11_X,
  XC_CORRELATION,
