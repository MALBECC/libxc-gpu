...
static void 
gga_x_kt_init(xc_func_type_cuda *p)
{
...
void 
xc_gga_x_kt_set_params(xc_func_type_cuda *p, double gamma, double delta)
{
...
const xc_func_info_type_cuda xc_func_info_gga_x_kt1 = {
  XC_GGA_X_KT1,
  XC_EXCHANGE,
...
static void
gga_xc_kt1_init(xc_func_type_cuda *p)
{
...
const xc_func_info_type_cuda xc_func_info_gga_xc_kt1 = {
  XC_GGA_XC_KT1,
...
static void
gga_xc_kt2_init(xc_func_type_cuda *p)
{
...
const xc_func_info_type_cuda xc_func_info_gga_xc_kt2 = {
  XC_GGA_XC_KT2,
  XC_EXCHANGE_CORRELATION,
