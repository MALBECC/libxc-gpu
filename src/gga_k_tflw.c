...
static void 
gga_k_tflw_set_params(xc_func_type_cuda *p, double gamma, double lambda, double N)
{
...
static void 
gga_k_tflw_init(xc_func_type_cuda *p)
{
...
static const func_params_type_cuda tfvw_ext_params[] = {
  {1.0, "Lambda"},
  {1.0, "Gamma"},
};

static void 
tfvw_set_ext_params(xc_func_type_cuda *p, const double *ext_params)
{
...
const xc_func_info_type_cuda xc_func_info_gga_k_tfvw = {
  XC_GGA_K_TFVW,
  XC_KINETIC,
...
const xc_func_info_type_cuda xc_func_info_gga_k_vw = {
  XC_GGA_K_VW,
  XC_KINETIC,
...
const xc_func_info_type_cuda xc_func_info_gga_k_ge2 = {
  XC_GGA_K_GE2,
  XC_KINETIC,
...
const xc_func_info_type_cuda xc_func_info_gga_k_golden = {
  XC_GGA_K_GOLDEN,
  XC_KINETIC,
...
const xc_func_info_type_cuda xc_func_info_gga_k_yt65 = {
  XC_GGA_K_YT65,
  XC_KINETIC,
...
const xc_func_info_type_cuda xc_func_info_gga_k_baltin = {
  XC_GGA_K_BALTIN,
  XC_KINETIC,
...
const xc_func_info_type_cuda xc_func_info_gga_k_lieb = {
  XC_GGA_K_LIEB,
  XC_KINETIC,
...
static const func_params_type_cuda N_ext_params[] = {
  {1.0, "Number of electrons"},
};

static void 
N_set_ext_params(xc_func_type_cuda *p, const double *ext_params)
{
  double ff, N;
...
const xc_func_info_type_cuda xc_func_info_gga_k_absp1 = {
  XC_GGA_K_ABSP1,
  XC_KINETIC,
...
const xc_func_info_type_cuda xc_func_info_gga_k_absp2 = {
  XC_GGA_K_ABSP2,
  XC_KINETIC,
...
const xc_func_info_type_cuda xc_func_info_gga_k_absp3 = {
  XC_GGA_K_ABSP3,
  XC_KINETIC,
...
const xc_func_info_type_cuda xc_func_info_gga_k_absp4 = {
  XC_GGA_K_ABSP4,
  XC_KINETIC,
...
const xc_func_info_type_cuda xc_func_info_gga_k_gr = {
  XC_GGA_K_GR,
  XC_KINETIC,
...
const xc_func_info_type_cuda xc_func_info_gga_k_ludena = {
  XC_GGA_K_LUDENA,
  XC_KINETIC,
...
const xc_func_info_type_cuda xc_func_info_gga_k_gp85 = {
  XC_GGA_K_GP85,
  XC_KINETIC,
