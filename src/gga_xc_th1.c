...
static void 
gga_xc_th1_init(xc_func_type_cuda *p)
{
...
const xc_func_info_type_cuda xc_func_info_gga_xc_th_fl = {
  XC_GGA_XC_TH_FL,
...
const xc_func_info_type_cuda xc_func_info_gga_xc_th_fc = {
  XC_GGA_XC_TH_FC,
  XC_EXCHANGE_CORRELATION,
...
const xc_func_info_type_cuda xc_func_info_gga_xc_th_fcfo = {
  XC_GGA_XC_TH_FCFO,
  XC_EXCHANGE_CORRELATION,
...
const xc_func_info_type_cuda xc_func_info_gga_xc_th_fco = {
  XC_GGA_XC_TH_FCO,
  XC_EXCHANGE_CORRELATION,
...
const xc_func_info_type_cuda xc_func_info_gga_xc_th1 = {
  XC_GGA_XC_TH1,
  XC_EXCHANGE_CORRELATION,
  "Tozer and Handy v. 1",
  XC_FAMILY_GGA,
