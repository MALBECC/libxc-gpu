...
static void 
lda_xc_1d_ehwlrg_init(xc_func_type_cuda *p)
{
...
const xc_func_info_type_cuda xc_func_info_lda_xc_1d_ehwlrg_1 = {
...
const xc_func_info_type_cuda xc_func_info_lda_xc_1d_ehwlrg_2 = {
...
const xc_func_info_type_cuda xc_func_info_lda_xc_1d_ehwlrg_3 = {
