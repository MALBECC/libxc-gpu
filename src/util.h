...
void xc_mix_init(xc_func_type_cuda *p, int n_funcs, const int *funcs_id, const double *mix_coef);

/* LDAs */
void xc_lda_init(xc_func_type_cuda *p);
void xc_lda_end (xc_func_type_cuda *p);
...
void xc_lda_fxc_fd(const xc_func_type_cuda *p, int np, const double *rho, double *fxc);
void xc_lda_kxc_fd(const xc_func_type_cuda *p, int np, const double *rho, double *kxc);
...
typedef void xc_lda_func_type (const xc_func_type_cuda *p, xc_lda_work_t *r);
...
void xc_lda_x_func     (const xc_func_type_cuda *p, xc_lda_work_t *r);
void xc_lda_x_erf_func (const xc_func_type_cuda *p, xc_lda_work_t *r);
void xc_lda_c_hl_func  (const xc_func_type_cuda *p, xc_lda_work_t *r);
void xc_lda_c_vwn_func (const xc_func_type_cuda *p, xc_lda_work_t *r);
void xc_lda_c_pw_func  (const xc_func_type_cuda *p, xc_lda_work_t *r);
void xc_lda_c_pz_func  (const xc_func_type_cuda *p, xc_lda_work_t *r);
void xc_lda_c_rc04_func(const xc_func_type_cuda *p, xc_lda_work_t *r);
void xc_lda_c_2d_amgb_func(const xc_func_type_cuda *p, xc_lda_work_t *r);
...
void work_gga_becke_init(xc_func_type_cuda *p);

/* exchange enhancement factors: if you add one, please add it also to the util.c */
typedef void(*xc_gga_enhancement_t)(const xc_func_type_cuda *, xc_gga_work_x_t *r);
xc_gga_enhancement_t xc_get_gga_enhancement_factor(int func_id);

void xc_gga_x_wc_enhance   (const xc_func_type_cuda *p, xc_gga_work_x_t *r);
//void xc_gga_x_pbe_enhance  (const xc_func_type_cuda *p, xc_gga_work_x_t *r);
void xc_gga_x_pw91_enhance (const xc_func_type_cuda *p, xc_gga_work_x_t *r);
void xc_gga_x_rpbe_enhance (const xc_func_type_cuda *p, xc_gga_work_x_t *r);
void xc_gga_x_htbs_enhance (const xc_func_type_cuda *p, xc_gga_work_x_t *r);
void xc_gga_x_b86_enhance  (const xc_func_type_cuda *p, xc_gga_work_x_t *r);
void xc_gga_x_b88_enhance  (const xc_func_type_cuda *p, xc_gga_work_x_t *r);
void xc_gga_x_g96_enhance  (const xc_func_type_cuda *p, xc_gga_work_x_t *r);
void xc_gga_x_pw86_enhance (const xc_func_type_cuda *p, xc_gga_work_x_t *r);
void xc_gga_x_airy_enhance (const xc_func_type_cuda *p, xc_gga_work_x_t *r);
void xc_gga_x_ak13_enhance (const xc_func_type_cuda *p, xc_gga_work_x_t *r);
void xc_gga_x_bayesian_enhance(const xc_func_type_cuda *p, xc_gga_work_x_t *r);
void xc_gga_x_bpccac_enhance(const xc_func_type_cuda *p, xc_gga_work_x_t *r);
void xc_gga_x_c09x_enhance (const xc_func_type_cuda *p, xc_gga_work_x_t *r);
void xc_gga_x_am05_enhance (const xc_func_type_cuda *p, xc_gga_work_x_t *r);
void xc_gga_x_dk87_enhance (const xc_func_type_cuda *p, xc_gga_work_x_t *r);
void xc_gga_x_herman_enhance (const xc_func_type_cuda *p, xc_gga_work_x_t *r);
void xc_gga_x_lg93_enhance (const xc_func_type_cuda *p, xc_gga_work_x_t *r);
void xc_gga_x_lv_rpw86_enhance (const xc_func_type_cuda *p, xc_gga_work_x_t *r);
void xc_gga_x_mpbe_enhance (const xc_func_type_cuda *p, xc_gga_work_x_t *r);
void xc_gga_x_optx_enhance (const xc_func_type_cuda *p, xc_gga_work_x_t *r);
void xc_gga_x_sogga11_enhance (const xc_func_type_cuda *p, xc_gga_work_x_t *r);
void xc_gga_x_ssb_sw_enhance (const xc_func_type_cuda *p, xc_gga_work_x_t *r);
void xc_gga_x_vmt_enhance (const xc_func_type_cuda *p, xc_gga_work_x_t *r);
...
typedef struct {
  ...
  double dfdrs, dfdz, dfdxt;
  double d2fdrs2, d2fdrsz, d2fdrsxt, d2fdz2,
    d2fdzxt, d2fdxt2;

} xc_gga_work_c_t_3;


void xc_gga_c_pw91_func(const xc_func_type_cuda *p, xc_gga_work_c_t *r);
//void xc_gga_c_pbe_func (const xc_func_type_cuda *p, xc_gga_work_c_t *r);
void xc_gga_c_pbeloc_func (const xc_func_type_cuda *p, xc_gga_work_c_t *r);
void xc_gga_c_regtpss_func (const xc_func_type_cuda *p, xc_gga_work_c_t *r);
void xc_gga_c_scan_e0_func (const xc_func_type_cuda *p, xc_gga_work_c_t *r);
void xc_gga_c_q2d_func (const xc_func_type_cuda *p, xc_gga_work_c_t *r);
...
void xc_gga_x_pw91_set_params(xc_func_type_cuda *p, double a, double b, double c, double d, double f, double alpha, double expo);
void xc_gga_x_pw91_set_params2(xc_func_type_cuda *p, double bt, double alpha, double expo);
void xc_gga_x_ssb_sw_set_params(xc_func_type_cuda *p, double A, double B, double C, double D, double E);
void xc_gga_x_hjs_set_params(xc_func_type_cuda *p, double omega);
void xc_gga_x_hjs_b88_v2_set_params(xc_func_type_cuda *p, double omega);
void xc_gga_x_b88_set_params(xc_func_type_cuda *p, double beta, double gamma);
void xc_gga_x_optx_set_params(xc_func_type_cuda *p, double a, double b, double gamma);
void xc_gga_x_wpbeh_set_params(xc_func_type_cuda *p, double omega);
//void xc_gga_x_pbe_set_params(xc_func_type_cuda *p, double kappa, double mu);
void xc_gga_x_pbeint_set_params(xc_func_type_cuda *p, double kappa, double alpha, double muPBE, double muGE);
void xc_gga_x_ityh_set_params(xc_func_type_cuda *p, int func_id, double omega);
void xc_gga_x_b86_set_params(xc_func_type_cuda *p, double beta, double gamma, double omega);
void xc_gga_x_rpbe_set_params(xc_func_type_cuda *p, double kappa, double mu);
void xc_gga_x_sfat_set_params(xc_func_type_cuda *p, int func_id, double omega);
void xc_gga_x_kt_set_params(xc_func_type_cuda *p, double gamma, double delta);
void xc_gga_c_lyp_set_params(xc_func_type_cuda *p, double A, double B, double c, double d);
//void xc_gga_c_pbe_set_params(xc_func_type_cuda *p, double beta);

//void xc_mgga_x_tpss_set_params(xc_func_type_cuda *p, double b, double c, double e, double kappa, double mu, double BLOC_a, double BLOC_b);
void xc_mgga_c_tpss_set_params(xc_func_type_cuda *p, double beta, double d, double C0_0, double C0_1, double C0_2, double C0_3);
void xc_mgga_c_pkzb_set_params(xc_func_type_cuda *p, double beta, double d, double C0_0, double C0_1, double C0_2, double C0_3);
//void xc_mgga_c_bc95_set_params(xc_func_type_cuda *p, double css, double copp);
...
const char *get_kind(const xc_func_type_cuda *func);
const char *get_family(const xc_func_type_cuda *func);
