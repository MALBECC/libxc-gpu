...
static void 
lda_c_chachiyo_init(xc_func_type_cuda *p)
{
...
const xc_func_info_type_cuda xc_func_info_lda_c_chachiyo = {
  XC_LDA_C_CHACHIYO,
  XC_CORRELATION,
...
const xc_func_info_type_cuda xc_func_info_lda_c_karasiev = {
  XC_LDA_C_KARASIEV,
  XC_CORRELATION,
