...
static void 
gga_x_optx_init(xc_func_type_cuda *p)
{
...
void 
xc_gga_x_optx_set_params(xc_func_type_cuda *p, double a, double b, double gamma)
{
...
const xc_func_info_type_cuda xc_func_info_gga_x_optx = {
  XC_GGA_X_OPTX,
  XC_EXCHANGE,
  "Handy & Cohen OPTX 01",
  XC_FAMILY_GGA,
