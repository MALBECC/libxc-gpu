...
static void 
lda_c_hl_init(xc_func_type_cuda *p)
{
...
const xc_func_info_type_cuda xc_func_info_lda_c_hl = {
  XC_LDA_C_HL,
  XC_CORRELATION,
  "Hedin & Lundqvist",
  XC_FAMILY_LDA,
...
const xc_func_info_type_cuda xc_func_info_lda_c_gl = {
  XC_LDA_C_GL,
  XC_CORRELATION,
  "Gunnarson & Lundqvist",
  XC_FAMILY_LDA,
...
const xc_func_info_type_cuda xc_func_info_lda_c_vbh = {
  XC_LDA_C_vBH,
  XC_CORRELATION,
  "von Barth & Hedin",
  XC_FAMILY_LDA,
