...
static void 
mgga_x_tau_hcth_init(xc_func_type_cuda *p)
{
...
const xc_func_info_type_cuda xc_func_info_mgga_x_tau_hcth = {
  XC_MGGA_X_TAU_HCTH,
  XC_EXCHANGE,
...
const xc_func_info_type_cuda xc_func_info_hyb_mgga_x_bmk = {
  XC_HYB_MGGA_X_BMK,
  XC_EXCHANGE,
...
const xc_func_info_type_cuda xc_func_info_hyb_mgga_x_tau_hcth = {
