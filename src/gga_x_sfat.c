...
static void
gga_x_sfat_init(xc_func_type_cuda *p)
{
...
void 
xc_gga_x_sfat_set_params(xc_func_type_cuda *p, int func_id, double omega)
{
...
static void 
func(const xc_func_type_cuda *pt, xc_gga_work_c_t *r)
{
  int is, js;
  gga_x_sfat_params *params;
  xc_gga_work_x_t aux;
...
const xc_func_info_type_cuda xc_func_info_gga_x_sfat = {
  XC_GGA_X_SFAT,
  XC_EXCHANGE,
