...
static void 
gga_xc_b97_init(xc_func_type_cuda *p)
{
...
const xc_func_info_type_cuda xc_func_info_hyb_gga_xc_b97 = {
  XC_HYB_GGA_XC_B97,
...
const xc_func_info_type_cuda xc_func_info_hyb_gga_xc_b97_1 = {
  XC_HYB_GGA_XC_B97_1,
  XC_EXCHANGE_CORRELATION,
  "Becke 97-1",
  XC_FAMILY_HYB_GGA,
...
const xc_func_info_type_cuda xc_func_info_hyb_gga_xc_b97_2 = {
  XC_HYB_GGA_XC_B97_2,
  XC_EXCHANGE_CORRELATION,
  "Becke 97-2",
  XC_FAMILY_HYB_GGA,
...
const xc_func_info_type_cuda xc_func_info_gga_xc_b97_d = {
  XC_GGA_XC_B97_D,
  XC_EXCHANGE_CORRELATION,
  "Becke 97-D",
  XC_FAMILY_GGA,
...
const xc_func_info_type_cuda xc_func_info_hyb_gga_xc_b97_k = {
  XC_HYB_GGA_XC_B97_K,
  XC_EXCHANGE_CORRELATION,
...
const xc_func_info_type_cuda xc_func_info_hyb_gga_xc_b97_3 = {
  XC_HYB_GGA_XC_B97_3,
  XC_EXCHANGE_CORRELATION,
  "Becke 97-3",
  XC_FAMILY_HYB_GGA,
...
const xc_func_info_type_cuda xc_func_info_gga_xc_hcth_93 = {
  XC_GGA_XC_HCTH_93,
  XC_EXCHANGE_CORRELATION,
  "HCTH/93",
  XC_FAMILY_GGA,
...
const xc_func_info_type_cuda xc_func_info_gga_xc_hcth_120 = {
  XC_GGA_XC_HCTH_120,
  XC_EXCHANGE_CORRELATION,
  "HCTH/120",
  XC_FAMILY_GGA,
...
const xc_func_info_type_cuda xc_func_info_gga_xc_hcth_147 = {
  XC_GGA_XC_HCTH_147,
  XC_EXCHANGE_CORRELATION,
  "HCTH/147",
  XC_FAMILY_GGA,
...
const xc_func_info_type_cuda xc_func_info_gga_xc_hcth_407 = {
  XC_GGA_XC_HCTH_407,
  XC_EXCHANGE_CORRELATION,
  "HCTH/407",
  XC_FAMILY_GGA,
...
const xc_func_info_type_cuda xc_func_info_hyb_gga_xc_sb98_1a = {
...
const xc_func_info_type_cuda xc_func_info_hyb_gga_xc_sb98_1b = {
...
const xc_func_info_type_cuda xc_func_info_hyb_gga_xc_sb98_1c = {
...
const xc_func_info_type_cuda xc_func_info_hyb_gga_xc_sb98_2a = {
...
const xc_func_info_type_cuda xc_func_info_hyb_gga_xc_sb98_2b = {
...
const xc_func_info_type_cuda xc_func_info_hyb_gga_xc_sb98_2c = {
...
const xc_func_info_type_cuda xc_func_info_gga_xc_b97_gga1 = {
  XC_GGA_XC_B97_GGA1,
  XC_EXCHANGE_CORRELATION,
  "Becke 97 GGA-1",
  XC_FAMILY_GGA,
...
const xc_func_info_type_cuda xc_func_info_gga_xc_hcth_p14 = {
  XC_GGA_XC_HCTH_P14,
  XC_EXCHANGE_CORRELATION,
  "HCTH p=1/4",
  XC_FAMILY_GGA, 
...
const xc_func_info_type_cuda xc_func_info_gga_xc_hcth_p76 = {
  XC_GGA_XC_HCTH_P76,
  XC_EXCHANGE_CORRELATION,
  "HCTH p=7/6",
  XC_FAMILY_GGA,
...
const xc_func_info_type_cuda xc_func_info_gga_xc_hcth_407p = {
  XC_GGA_XC_HCTH_407P,
  XC_EXCHANGE_CORRELATION,
  "HCTH/407+",
  XC_FAMILY_GGA,
...
const xc_func_info_type_cuda xc_func_info_hyb_gga_xc_b97_1p = {
...
const xc_func_info_type_cuda xc_func_info_gga_xc_hle16 = {
  XC_GGA_XC_HLE16,
  XC_EXCHANGE_CORRELATION,
