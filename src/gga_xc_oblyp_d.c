...
static void
gga_xc_oblyp_d_init(xc_func_type_cuda *p)
{
...
const xc_func_info_type_cuda xc_func_info_gga_xc_oblyp_d = {
  XC_GGA_XC_OBLYP_D,
...
static void
gga_xc_opwlyp_d_init(xc_func_type_cuda *p)
{
...
const xc_func_info_type_cuda xc_func_info_gga_xc_opwlyp_d = {
  XC_GGA_XC_OPWLYP_D,
  XC_EXCHANGE_CORRELATION,
...
static void
gga_xc_opbe_d_init(xc_func_type_cuda *p)
{
  static int   funcs_id  [4] = {XC_GGA_X_PBE_cuda, XC_GGA_C_PBE_cuda};
  static double funcs_coef[4] = {1.0, 1.0};
...
const xc_func_info_type_cuda xc_func_info_gga_xc_opbe_d = {
  XC_GGA_XC_OPBE_D,
  XC_EXCHANGE_CORRELATION,
