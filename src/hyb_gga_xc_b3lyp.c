...
/*************************************************************/
void
xc_hyb_gga_xc_b3pw91_init(xc_func_type_cuda *p)
{
...
const xc_func_info_type_cuda xc_func_info_hyb_gga_xc_b3pw91 = {
...
/*************************************************************/
void
xc_hyb_gga_xc_b3lyp_init(xc_func_type_cuda *p)
{
...
const xc_func_info_type_cuda xc_func_info_hyb_gga_xc_b3lyp = {
  XC_HYB_GGA_XC_B3LYP,
  XC_EXCHANGE_CORRELATION,
  "B3LYP",
  XC_FAMILY_HYB_GGA,
...
/*************************************************************/
void
xc_hyb_gga_xc_b3lyp5_init(xc_func_type_cuda *p)
{
...
const xc_func_info_type_cuda xc_func_info_hyb_gga_xc_b3lyp5 = {
...
/*************************************************************/
void
xc_hyb_gga_xc_b3p86_init(xc_func_type_cuda *p)
{
...
const xc_func_info_type_cuda xc_func_info_hyb_gga_xc_b3p86 = {
  XC_HYB_GGA_XC_B3P86,
  XC_EXCHANGE_CORRELATION,
  "B3P86",
  XC_FAMILY_HYB_GGA,
...
/*************************************************************/
void
xc_hyb_gga_xc_mpw3pw_init(xc_func_type_cuda *p)
{
...
const xc_func_info_type_cuda xc_func_info_hyb_gga_xc_mpw3pw = {
...
/*************************************************************/
void
xc_hyb_gga_xc_mpw3lyp_init(xc_func_type_cuda *p)
{
...
const xc_func_info_type_cuda xc_func_info_hyb_gga_xc_mpw3lyp = {
...
/*************************************************************/
void
xc_hyb_gga_xc_mb3lyp_rc04_init(xc_func_type_cuda *p)
{
...
const xc_func_info_type_cuda xc_func_info_hyb_gga_xc_mb3lyp_rc04 = {
...
/*************************************************************/
void
xc_hyb_gga_xc_revb3lyp_init(xc_func_type_cuda *p)
{
  static int   funcs_id  [4] = {XC_LDA_X, XC_GGA_X_B88, XC_LDA_C_VWN_RPA, XC_GGA_C_LYP};
...
const xc_func_info_type_cuda xc_func_info_hyb_gga_xc_revb3lyp = {
...
/*************************************************************/
void
xc_hyb_gga_xc_b3lyps_init(xc_func_type_cuda *p)
{
  static int   funcs_id  [4] = {XC_LDA_X, XC_GGA_X_B88, XC_LDA_C_VWN_RPA, XC_GGA_C_LYP};
...
const xc_func_info_type_cuda xc_func_info_hyb_gga_xc_b3lyps = {
...
/*************************************************************/
void
xc_hyb_gga_xc_b5050lyp_init(xc_func_type_cuda *p)
{
  static int   funcs_id  [4] = {XC_LDA_X, XC_GGA_X_B88, XC_LDA_C_VWN, XC_GGA_C_LYP};
...
const xc_func_info_type_cuda xc_func_info_hyb_gga_xc_b5050lyp = {
...
/*************************************************************/
void
xc_hyb_gga_xc_kmlyp_init(xc_func_type_cuda *p)
{
...
const xc_func_info_type_cuda xc_func_info_hyb_gga_xc_kmlyp = {
  XC_HYB_GGA_XC_KMLYP,
  XC_EXCHANGE_CORRELATION,
