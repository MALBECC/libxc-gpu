...
static void
gga_x_n12_init(xc_func_type_cuda *p)
{
...
const xc_func_info_type_cuda xc_func_info_gga_x_n12 = {
  XC_GGA_X_N12,
  XC_EXCHANGE,
...
const xc_func_info_type_cuda xc_func_info_hyb_gga_x_n12_sx = {
  XC_HYB_GGA_X_N12_SX,
  XC_EXCHANGE,
...
const xc_func_info_type_cuda xc_func_info_gga_x_gam = {
  XC_GGA_X_GAM,
  XC_EXCHANGE,
