...
static void 
gga_x_pw86_init(xc_func_type_cuda *p)
{
...
const xc_func_info_type_cuda xc_func_info_gga_x_pw86 = {
  XC_GGA_X_PW86,
  XC_EXCHANGE,
  "Perdew & Wang 86",
  XC_FAMILY_GGA,
...
const xc_func_info_type_cuda xc_func_info_gga_x_rpw86 = {
  XC_GGA_X_RPW86,
  XC_EXCHANGE,
...
const xc_func_info_type_cuda xc_func_info_gga_k_fr_pw86 = {
  XC_GGA_K_FR_PW86,
  XC_KINETIC,
