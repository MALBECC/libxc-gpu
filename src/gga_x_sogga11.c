...
static void 
gga_x_sogga11_init(xc_func_type_cuda *p)
{
...
const xc_func_info_type_cuda xc_func_info_gga_x_sogga11 = {
  XC_GGA_X_SOGGA11,
  XC_EXCHANGE,
...
const xc_func_info_type_cuda xc_func_info_hyb_gga_x_sogga11_x = {
