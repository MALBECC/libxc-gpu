...
static void
hyb_mgga_xc_kcis_init(xc_func_type_cuda *p)
{
  /* Exchange functional */
  int xid;
...
const xc_func_info_type_cuda xc_func_info_hyb_mgga_xc_mpw1kcis = {
...
const xc_func_info_type_cuda xc_func_info_hyb_mgga_xc_mpwkcis1k = {
...
const xc_func_info_type_cuda xc_func_info_hyb_mgga_xc_pbe1kcis = {
...
const xc_func_info_type_cuda xc_func_info_hyb_mgga_xc_tpss1kcis = {
