...
static void 
gga_x_b88_init(xc_func_type_cuda *p)
{
...
void 
xc_gga_x_b88_set_params(xc_func_type_cuda *p, double beta, double gamma)
{
...
const xc_func_info_type_cuda xc_func_info_gga_x_b88 = {
  XC_GGA_X_B88,
  XC_EXCHANGE,
  "Becke 88",
  XC_FAMILY_GGA,
...
const xc_func_info_type_cuda xc_func_info_gga_x_optb88_vdw = {
  XC_GGA_X_OPTB88_VDW,
  XC_EXCHANGE,
...
const xc_func_info_type_cuda xc_func_info_gga_x_mb88 = {
  XC_GGA_X_MB88,
  XC_EXCHANGE,
...
const xc_func_info_type_cuda xc_func_info_gga_x_eb88 = {
  XC_GGA_X_EB88,
  XC_EXCHANGE,
...
const xc_func_info_type_cuda xc_func_info_gga_x_b88m = {
  XC_GGA_X_B88M,
  XC_EXCHANGE,
...
const xc_func_info_type_cuda xc_func_info_gga_k_llp = {
  XC_GGA_K_LLP,
  XC_KINETIC,
  "Lee, Lee & Parr",
  XC_FAMILY_GGA,
...
const xc_func_info_type_cuda xc_func_info_gga_k_fr_b88 = {
  XC_GGA_K_FR_B88,
  XC_KINETIC,
